                  ...
                  <table class="wMobile" cellpadding="0" cellspacing="0" border="0" role="presentation" style="width:100%;">
                        ...
                        <tr>
                          <td align="center" valign="top">
                            ...
                            <!--Contenu du message-->
                            <p style="font-family: 'Trebuchet MS', Arial, sans-serif; font-size:16px; line-height:22px; color:#0a080b; margin: 0 0 30px; padding:0; text-align: left;">
                                Un utilisateur a soumis une demande via le formulaire de contact. Voici les détails :
                            </p>
                        
                            <!--Détails du contact-->
                            <ul style="font-family: 'Trebuchet MS', Arial, sans-serif; font-size:16px; line-height:22px; color:#0a080b; margin: 0 0 30px; padding:0; text-align: left;">
