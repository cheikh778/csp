...
<head>
  ...
  <title>CSP - Vérification Email</title>
</head>
        ...
        <table cellpadding="0" cellspacing="0" border="0" role="presentation" style="width:100%;">
          ...
          <tr>
            <td align="center">
              ...
              <p style="font-size:16px; line-height:22px; color:#0a080b;">Vous avez été ajouté comme gérant de la plateforme de CSP. Veuillez vérifier votre adresse email en cliquant sur le lien ci-dessous :</p>
              <p><a href="{{ $verification_link }}" target="_blank" style="color: #174fdd; text-decoration: underline;">Vérifier mon adresse e-mail &rarr;</a></p>
              <p style="font-size:16px; line-height:22px; color:#0a080b;">Si vous n'avez pas créé de compte, veuillez ignorer cet email.</p>
            </td>
          </tr>
          <tr>
            <td>
